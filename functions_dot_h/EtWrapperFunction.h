...
//local includes
#include "EtStruct.h"
#include "EtCalcProperty.h"
#include "EtEnergyBalanceMethod.h"
#include "EtAerodynamicMethod.h"
#include "EtCombinationMethod.h"
#include "EtPriestleyTaylorMethod.h"
#include "EtPenmanMonteithMethod.h"
...
double et_wrapper_function(struct aorc_forcing_data*          aorc_forcing,
                           struct solar_radiation_options*    solar_rad_options,
                           struct solar_radiation_parameters* solar_rad_params,
                           struct solar_radiation_forcing*    solar_rad_forcing,
                           struct evapotranspiration_options* set_et_options,
                           struct evapotranspiration_params*  set_et_params,
                           struct evapotranspiration_forcing* set_et_forcing,
                           struct surface_radiation_params*   surface_rad_params,
                           struct surface_radiation_forcing*  surface_rad_forcing)
{
